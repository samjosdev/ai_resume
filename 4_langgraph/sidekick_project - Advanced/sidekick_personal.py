...
from sidekick_tools_personal import other_tools, playwright_tools
import uuid
import asyncio
...
class EvaluatorOutput(BaseModel):
    ...
    user_input_needed: bool = Field(description="True if more input is needed from the user, or clarifications are needed or assistant is stuck")
...
class SideKick:
    ...
    def evaluator(self, state:State)->State:
        ...
        eval_result = self.evaluator_llm_with_structured_output.invoke(evaluator_messages)
        new_state = {
    ...
    async def build_graph(self):
        ...
        graph_builder.add_conditional_edges("evaluator",self.route_based_on_evaluation, {"END": END, "worker": "worker"})
    ...
    async def run_superstep(self, message, success_criteria, history):
        ...
        #Append the new user message to history before passing into state
